...
<p className=' text-5xl mt-10 font-extrabold text-center '>You are just a click away.<AdsClickTwoToneIcon style={{ fontSize: '80px', color: '#dc2626' }} /></p>
            <div className=' bg-white mx-40 shadow-md px-6 rounded-md mt-10'>
                <div className='flex justify-between items-center'>
                    <p className='text-4xl font-bold text-center pt-10'>{singleJob?.title} </p>
                    {/* <img src={singleJob?.company?.logo} alt="" width={100} height={100} /> */}
                </div>
                <div className='mt-10 flex justify-between'>
                    <p><RoomIcon />{singleJob?.location}</p>
                    <p><SupervisorAccountIcon /> {singleJob?.applications?.length} Applicant</p>
                    <p className=' text-green-600'><MeetingRoomIcon /> Open</p>
                    <p><HourglassBottomIcon />Apply By- 20 Dec' 24</p>
                </div>
                ...
                <Button
                    onClick={isApplied ? null : applyJobHandler}
                    disabled={isApplied}
                    className={`rounded-lg ${isApplied ? 'bg-gray-600 w-full text-lg cursor-not-allowed my-8' : 'bg-black hover:bg-slate-800 text-lg w-full my-8'}`}>
                    {isApplied ? 'Already Applied' : 'Apply Now'}
                </Button>
            </div>
        </div>
